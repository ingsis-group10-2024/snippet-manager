...
//    private lateinit var ruleChangerProducer: RedisRuleChangerProducer
    ...
    @Mock
    private lateinit var snippetValidationProducer: SnippetValidationProducer
    ...
    fun setUp() {
        ...
        ruleService = RuleService(ruleRepository, snippetService, snippetValidationProducer)
    }
    ...
    fun `createOrUpdateRules should create new rules if they do not exist`() {
        ...
        val result = ruleService.createOrUpdateRules(newRules, ruleType, userId, authHeader)
